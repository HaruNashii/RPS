...
{
    let application_state: AppState<TestPage, TestButton> = AppState::new(TestPage::Home, (1920, 1080), true);
...
{
    let mut application_state: AppState<TestPage, TestButton> = AppState::new(TestPage::Profile, (1920, 1080), true);
